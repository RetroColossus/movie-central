...
// export const getBooks = (trending) => {
//     return fetch(`https://api.nytimes.com/svc/books/v3/lists/current/hardcover-fiction.json${trending}?api-key=G093NhfpMaGRZb77MeoLXeuBI1B9SlEH`);
// };
